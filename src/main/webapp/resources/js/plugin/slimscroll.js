        ...
        insertCss = function(){
            if(!window.slimScrollStylesApplied){
                ...
                var slim = "["+l+"]",
                    ...
                    // classes
                    w = pA+";overflow:auto"+imp+";left:0px;top:0px"+imp+";right:0px;bottom:0px"+imp+";",
...
//                C[iH] = "";
        ...
        placeIt = function(){
            ...
            // Make scrolls invisible when zooming in 
            if(i[w].offsetWidth < i[w].clientWidth) {
            	scrollBarWidth = i[w].clientWidth - i[w].offsetWidth;
            }
