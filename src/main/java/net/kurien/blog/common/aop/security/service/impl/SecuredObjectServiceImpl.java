package net.kurien.blog.common.aop.security.service.impl;
...
import net.kurien.blog.common.aop.security.dao.SecuredObjectDao;
import net.kurien.blog.common.aop.security.service.SecuredObjectService;

public class SecuredObjectServiceImpl implements SecuredObjectService {
	public SecuredObjectDao securedObjectDao;
	
	public SecuredObjectDao getSecuredObjectDao() {
		return securedObjectDao;
	}
	
	public void setSecureObjectDao(SecuredObjectDao securedObjectDao) {
